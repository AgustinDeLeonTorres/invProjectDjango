...
SECRET_KEY = 'django-insecure-ta)oxg67bovto&3$o0-x!-b5u#ilw(imgjhrl4c2ogotc7r&&a'
...
INSTALLED_APPS = [
    ...
    'invApp',  # Custom application for inventory management
    'crispy_forms',  # For crispy forms integration
